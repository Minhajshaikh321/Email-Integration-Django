...
#     print('send message start hereee')
#     s=MedicalStudents.objects.get(id=id)
#     subject="Welcome to Mcc"
#     message="django core topics"
...
#     s=MedicalStudents.objects.get(id=id)
#     print(s)
#     subject="Welcome to Mumbai coding club"
...
#     print('eng',eng)
    ...
    if request.method == "POST":
        ...
        reciptient=[med.email]
        send_mail("task",message,emailfrom,reciptient)
    return redirect('showdata')
